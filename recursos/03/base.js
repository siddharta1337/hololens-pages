...
function inicio() {
  ...
  var squareVertices = [
    +0.75, +0.75, 0.5, +0.0, +1.0,
    -0.75, +0.75, 1.0, +1.0, +0.0,
    +0.75, -0.75, 1.0, +0.0, +0.0,
    -0.75, -0.75, 1.0, +1.0, +0.5
  ]
  ...
  objetoWgl.vertexAttribPointer(
    programa.positionAttribute, 2, objetoWgl.FLOAT, false, Float32Array.BYTES_PER_ELEMENT * 5, 0
  );


  programa.colourAttribute = objetoWgl.getAttribLocation(programa, 'colour');

  objetoWgl.enableVertexAttribArray(programa.colourAttribute);


  objetoWgl.vertexAttribPointer(
    programa.colourAttribute, 3, objetoWgl.FLOAT, false,
